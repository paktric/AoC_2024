// Advent of Code 2024, Day 01, Part 2
// Patrick Moran
...
public class Day01_Part2 {
    public static void main(String[] args) {
        ...
        // Get the total similarity score between the left and right ArrayLists
        int sum = 0;
        for (int i = 0; i < arrLeft.size(); i++) {
            sum += arrLeft.get(i) * Collections.frequency(arrRight, arrLeft.get(i));
        }

        // Fin!
        System.out.println("AoC Day 01, Part 2 answer: " + sum);
    }
}